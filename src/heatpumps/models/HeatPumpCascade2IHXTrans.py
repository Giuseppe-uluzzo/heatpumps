...
class HeatPumpCascade2IHXTrans(HeatPumpCascadeBase):
    ...
    def generate_components(self):
        ...
        self.comps['power_distribution'] = PowerBus(
            'Power Distribution', num_in=1, num_out=4
            )
        self.comps['motor_LT_comp'] = Motor(self.comps['LT_comp'].label + ' Motor')
        self.comps['motor_HT_comp'] = Motor(self.comps['HT_comp'].label + ' Motor')
    ...
    def generate_connections(self):
        ...
        rotating_comps = ['LT_comp', 'HT_comp', 'hs_pump', 'cons_pump']
        power_conns = [
            PowerConnection(
